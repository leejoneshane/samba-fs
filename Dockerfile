...
RUN apk update \
    && apk --no-cache --no-progress add openrc bash sudo zip acl attr samba freeradius openldap-clients openldap \
                                        openldap-back-mdb perl perl-ldap perl-mojolicious \
